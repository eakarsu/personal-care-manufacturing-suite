...
PORT="${PORT:-5760}"
DB_NAME="${PGDATABASE:-personal_care_manufacturing_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Personal Care Manufacturing Suite"
echo "======================================="
echo
...
echo "Starting personal care manufacturing suite frontend on http://localhost:$PORT"
echo "Login: admin@personal-care-manufacturing.local / admin123"
