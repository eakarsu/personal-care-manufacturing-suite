...
const entitySeeds = [
  ['records', 'Orders Records', 'Orders priority queue', 'Open', 'Orders exception list', 'Manufacturing Lead', '$0'],
  ['work-centers', 'Work Centers Records', 'Work Centers priority queue', 'Review', 'Work Centers exception list', 'Manufacturing Lead', '$0'],
  ['materials', 'Materials Records', 'Materials priority queue', 'Action needed', 'Materials exception list', 'Manufacturing Lead', '$0'],
  ['quality', 'Quality Records', 'Quality priority queue', 'Open', 'Quality exception list', 'Manufacturing Lead', '$0'],
  ['maintenance', 'Maintenance Records', 'Maintenance priority queue', 'Review', 'Maintenance exception list', 'Operations Lead', '$0'],
  ['safety', 'Safety Records', 'Safety priority queue', 'Action needed', 'Safety exception list', 'Operations Lead', '$0'],
  ['suppliers', 'Suppliers Records', 'Suppliers priority queue', 'Open', 'Suppliers exception list', 'Operations Lead', '$0'],
  ...
  ['capacity', 'Capacity Records', 'Capacity priority queue', 'Open', 'Capacity exception list', 'Governance Lead', '$0'],
