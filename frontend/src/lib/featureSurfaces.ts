...
const featureSeeds = [
  ['records', 'Orders', 'Orders operating queue', 'Manufacturing Lead', 'Review and assign next action'],
  ['work-centers', 'Work Centers', 'Work Centers operating queue', 'Manufacturing Lead', 'Review and assign next action'],
  ['materials', 'Materials', 'Materials operating queue', 'Manufacturing Lead', 'Review and assign next action'],
  ['quality', 'Quality', 'Quality operating queue', 'Manufacturing Lead', 'Review and assign next action'],
  ['maintenance', 'Maintenance', 'Maintenance operating queue', 'Operations Lead', 'Review and assign next action'],
  ['safety', 'Safety', 'Safety operating queue', 'Operations Lead', 'Review and assign next action'],
  ...
  ['exceptions', 'Exceptions', 'Exceptions operating queue', 'Governance Lead', 'Review and assign next action'],
  ['capacity', 'Capacity', 'Capacity operating queue', 'Governance Lead', 'Review and assign next action'],
  ['analytics', 'Analytics', 'Analytics operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
