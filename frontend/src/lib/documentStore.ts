...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Orders Packet', type: 'Orders', owner: 'Manufacturing Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Work Centers Review Bundle', type: 'Work Centers', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Materials Evidence Set', type: 'Materials', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
