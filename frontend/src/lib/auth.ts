export const AUTH_COOKIE = 'personal_care_manufacturing_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@personal-care-manufacturing.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@personal-care-manufacturing.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@personal-care-manufacturing.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
