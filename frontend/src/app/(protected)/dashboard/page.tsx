...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Personal Care Manufacturing Dashboard"
      subtitle="One merged personal care manufacturing view for Orders, Work Centers, Materials, Quality, Maintenance, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared personal care manufacturing jobs into one surface. Orders, Work Centers, Materials, Quality, Maintenance, Safety, documents, audit, and AI are presented as platform features.</div>
